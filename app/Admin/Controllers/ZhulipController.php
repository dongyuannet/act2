...
class ZhulipController extends Controller
{
    use ModelForm;
    ...
    {
        return Admin::grid(Zhulip::class, function (Grid $grid) {

            $grid->model()->orderBy('zhu','desc');
            $grid->id('ID')->sortable();
    ...
    {
        return Admin::form(Zhulip::class, function (Form $form) {
